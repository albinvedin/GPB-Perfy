...
func validateN(iterations int, warmup int, message *pgv.EnumRangeConst) []int64 {
...
func validate(message *pgv.EnumRangeConst) int64 {
	startTime := time.Now()
	message.Validate()
...
func createMessage(messageLength int) *pgv.EnumRangeConst {
	message := new(pgv.EnumRangeConst)
