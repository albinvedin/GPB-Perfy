...
func validateN(iterations int, warmup int, message *pgv.StringRangeSuffix) []int64 {
...
func validate(message *pgv.StringRangeSuffix) int64 {
	startTime := time.Now()
	message.Validate()
...
func createMessage(messageLength int) *pgv.StringRangeSuffix {
	message := new(pgv.StringRangeSuffix)
