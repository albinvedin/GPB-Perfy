#include <iostream>
#include <string>
// #include "../pgv/gen/cpp/int64range.pb.h"
#include "../pgv/gen/cpp/int64range.pb.validate.h"

pgv::Int64Range createMessage(int elementCount) {
  pgv::Int64Range message {};
  message.add_content(1);
...
int main(int argc, char** argv) {
  ...
  pgv::Int64Range const message { createMessage(elementCount) };
