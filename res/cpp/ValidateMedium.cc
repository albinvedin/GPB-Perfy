...
std::vector<std::int64_t> repeatedValidate(pgv::Medium const& message, int warmup, int iterations, pgv::ValidationMsg &err);
int64_t validateOne(pgv::Medium const& message, pgv::ValidationMsg &err);
