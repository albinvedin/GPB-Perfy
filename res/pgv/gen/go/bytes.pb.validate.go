...
// Validate checks the field values on BytesRangeMinLen with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *BytesRangeMinLen) Validate() error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetContent() {
		...
		if len(item) < 10 {
			return BytesRangeMinLenValidationError{
				field:  fmt.Sprintf("Content[%v]", idx),
...
// BytesRangeMinLenValidationError is the validation error returned by
// BytesRangeMinLen.Validate if the designated constraints aren't met.
type BytesRangeMinLenValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BytesRangeMinLenValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BytesRangeMinLenValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BytesRangeMinLenValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BytesRangeMinLenValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BytesRangeMinLenValidationError) ErrorName() string { return "BytesRangeMinLenValidationError" }

// Error satisfies the builtin error interface
func (e BytesRangeMinLenValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBytesRangeMinLen.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BytesRangeMinLenValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BytesRangeMinLenValidationError{}
